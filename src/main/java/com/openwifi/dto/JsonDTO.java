...
public class JsonDTO {
   ...
   public JsonDTO(String distance, String x_SWIFI_MGR_NO, String x_SWIFI_WRDOFC, String x_SWIFI_MAIN_NM,
         String x_SWIFI_ADRES1, String x_SWIFI_ADRES2, String x_SWIFI_INSTL_FLOOR, String x_SWIFI_INSTL_TY,
         String x_SWIFI_INSTL_MBY, String x_SWIFI_SVC_SE, String x_SWIFI_CMCWR, int x_SWIFI_CNSTC_YEAR,
   ...
   public String toString() {
      return "JsonDTO [distance=" + distance + ", X_SWIFI_MGR_NO=" + X_SWIFI_MGR_NO + ", X_SWIFI_WRDOFC="
            + X_SWIFI_WRDOFC + ", X_SWIFI_MAIN_NM=" + X_SWIFI_MAIN_NM + ", X_SWIFI_ADRES1=" + X_SWIFI_ADRES1
            + ", X_SWIFI_ADRES2=" + X_SWIFI_ADRES2 + ", X_SWIFI_INSTL_FLOOR=" + X_SWIFI_INSTL_FLOOR
            + ", X_SWIFI_INSTL_TY=" + X_SWIFI_INSTL_TY + ", X_SWIFI_INSTL_MBY=" + X_SWIFI_INSTL_MBY
            + ", X_SWIFI_SVC_SE=" + X_SWIFI_SVC_SE + ", X_SWIFI_CMCWR=" + X_SWIFI_CMCWR + ", X_SWIFI_CNSTC_YEAR="
            + X_SWIFI_CNSTC_YEAR + ", X_SWIFI_INOUT_DOOR=" + X_SWIFI_INOUT_DOOR + ", X_SWIFI_REMARS3="
            + X_SWIFI_REMARS3 + ", LAT=" + LAT + ", LNT=" + LNT + ", WORK_DTTM=" + WORK_DTTM + "]";
   }
